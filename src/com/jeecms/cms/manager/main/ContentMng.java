...
public interface ContentMng {
	 ...
	 * @param approver	审批
	 * @param typeId	文章类型
	 * @param inputUserId 文章录入用户id
	 * @param inputDepartment  文章录入用户部门
	 * @param topLevel 置顶级别
	 * @param recommend 是否推荐
	 * @param status 审核状态
	 * @param checkStep 审核状态
	 * @param siteId 站点id
	 ...
	 * date：2016年1月14日
	 */
	public Pagination getPageByRight(String title,String author, String editor,
			String approver, Integer typeId,
			Integer inputUserId,Integer inputDepartment, boolean topLevel, boolean recommend,
