...
public class CmsStatisticSvcImpl implements CmsStatisticSvc {
	...
	public List<Object[]> statisticRank(Integer count,Date beginDate,Date endDate,Integer channelId,Integer siteId,Integer departmentId,String pattern,String contentStatus){
		return dao.statisticRank(count,beginDate,endDate,channelId,siteId,departmentId, pattern,contentStatus);
	}
	...
	public long statisticRankTotal(Date beginDate, Date endDate,
		...
		return dao.statisticRankTotal(beginDate, endDate, channelId, siteId,departmentId, pattern,contentStatus);
	}
	@Override
	public List<Object[]> getThisDepartmentCount(Date beginDate, Date endDate,
		...
		return dao.getThisDepartmentCount(beginDate,endDate,channelId,siteId,departmentId,contentStatus);
		
	}
	@Override
	public long getThisDepartmentCountTotal(Date beginDate, Date endDate,
			Integer channelId, Integer siteId, Integer departmentId,String contentStatus) {
		return dao.getThisDepartmentCountTotal(beginDate,endDate,channelId,siteId,departmentId,contentStatus);
	}
	...
	public List<Object[]> statisticRankByPattern(Integer viewCount,
		...
		return dao.statisticRankByPattern(viewCount,
				 beginDate,  endDate,  channelId,  siteId,
				 contentStatus,  patternArr);
	}
	...
	public long statisticRankTotalByPattern(Date beginDate, Date endDate,
			...
			String pattern) {
		String[] patternArr = pattern.split(",");
		return dao.statisticRankTotalByPattern( beginDate,  endDate,  channelId,  siteId,
				 contentStatus,  patternArr);
	}
