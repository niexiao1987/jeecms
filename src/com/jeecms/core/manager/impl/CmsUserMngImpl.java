...
public class CmsUserMngImpl implements CmsUserMng {
	...
	public CmsUser registerMember(String username, String email,
			...
			boolean disabled, CmsUserExt userExt, Map<String, String> attr) {
	...
	public CmsUser saveAdmin(String username, String email, String password,
			...
			Boolean[] allChannels, CmsUserExt userExt) {
		UnifiedUser unifiedUser = unifiedUserMng.save(username, email,
				password, ip);
		CmsUser user = new CmsUser();
		...
		if (departmentId != null) {
			...
			user.setDepartment(department);//设置部门
		} 
		//暂时不抛异常
//		if (department == null) {
//			throw new RuntimeException(
...
//		
	...
	public CmsUser updateAdmin(CmsUser bean, CmsUserExt ext, String password,
		...
		CmsUser user = updateAdmin(bean, ext, password, groupId, departmentId,
				roleIds, channelIds);
		// 更新所属站点
	...
	@Override
	public List<CmsUser> getListByDepartment(Integer departmentId) {
		return dao.getListByDepartment(departmentId);
	}
