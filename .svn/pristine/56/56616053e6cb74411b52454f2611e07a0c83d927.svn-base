...
public class CmsStatistic {
	...
	//增加排名统计at2015-12-24  by zhengpp
	public static final int CONTENTCONTRIBUTE = 21;//投稿数量
	public static final int CONTENTVIEWS = 21;//点击数量
	public static final int CONTENTCOMMENTS = 21;//评论数量
	public static final int CONTENTUP = 21;//顶数量
