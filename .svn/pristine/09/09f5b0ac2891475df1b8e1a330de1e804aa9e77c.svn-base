...
public class CmsAuthorizingRealm extends AuthorizingRealm {
	private static final String SSOLOGIN = "SSOLOGIN";
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		if (user != null) {
			...
			if(Constants.SSO_FLAG.equals(sb.toString())){
				return new SimpleAuthenticationInfo(user.getUsername(), SSOLOGIN,
						getName());
			}else{
