...
public class WelcomeAct {
	...
	public String right(HttpServletRequest request, ModelMap model) {
		...
		// 最新10条待审内容
		List<Content> contents = (List<Content>) contentMng.getPageByRight(
				null, null, null, null, null, null, null, false, false,
				ContentStatus.prepared, currStep, site.getId(), null,
				user.getId(), 0, 1, 10).getList();
		List<Content> newcontents = (List<Content>) contentMng.getPageByRight(
				null, null, null, null, null, null, null, false, false,
				ContentStatus.checked, currStep, site.getId(), null,
				user.getId(), 0, 1, 10).getList();
