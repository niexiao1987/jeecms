...
public abstract class BaseContent  implements Serializable {
	...
	//已经审核通过的时间,判断是否加new图标
	private java.lang.Long haveCheckedTime;

	public java.lang.Long getHaveCheckedTime() {
		return haveCheckedTime;
	}
	public void setHaveCheckedTime(java.lang.Long haveCheckedTime) {
		this.haveCheckedTime = haveCheckedTime;
	}
