...
public class CmsUser extends BaseCmsUser implements PriorityInterface {
	...
	public boolean hasApplyToday(Integer contentId) {
		...
		Set<CmsJobApply> jobApplys = getJobApplys();
		for (CmsJobApply apply : jobApplys) {
			if (DateUtils.isInDate(now, apply.getApplyTime())
					&& apply.getContent().getId().equals(contentId)) {
				return true;
			}
		}
		return false;
	 ...
	 */
	public CmsUser(java.lang.Integer id, com.jeecms.core.entity.CmsGroup group,
	...
	public Integer getDepartmentId() {
		if (super.getDepartment() != null) {
			return super.getDepartment().getId();
		} else {
			return null;
		}
	}
	...
	public String getDepartmentName() {
		if (super.getDepartment() != null) {
			return super.getDepartment().getName();
		} else {
			return null;
		}
	}
